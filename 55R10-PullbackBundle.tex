...
\usepackage{pmmeta}
\pmcanonicalname{PullbackBundle}
\pmcreated{2013-03-22 13:17:19}
\pmmodified{2013-03-22 13:17:19}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{pullback bundle}
\pmrecord{7}{33775}
\pmprivacy{1}
...
\pmsynonym{induced bundle}{PullbackBundle}
...
by $f$, and the map $\vp:E'\to E$ given by the restriction of projection.
...
$$\xymatrix{ 
	&\ar[ddl]X\ar[ddr]\ar@{-->}[d]	&\\
	&\ar[dl]^{f^*{\pi}}E'\ar[dr]_\vp	&\\
B'\ar[dr]^f	& 			&E\ar[dl]_\pi\\
          	&B			&		}$$
