...
\usepackage{pmmeta}
\pmcanonicalname{LocallyTrivialBundle}
\pmcreated{2013-03-22 13:15:01}
\pmmodified{2013-03-22 13:15:01}
\pmowner{mps}{409}
\pmmodifier{mps}{409}
\pmtitle{locally trivial bundle}
\pmrecord{10}{33727}
\pmprivacy{1}
\pmauthor{mps}{409}
\pmtype{Definition}
...
must be \PMlinkname{commutative}{CommutativeDiagram}.
...
\PMlinkname{long exact sequence}{LongExactSequenceLocallyTrivialBundle} and Serre spectral sequence.  Every fibre bundle is an example of a locally trivial bundle.
%%%%%
%%%%%
\end{document}
